...
<div class="container d-flex flex-column justify-content-center align-items-center gap-3 p-5 mt-5 mb-5 bg-dark rounded">
    ...
    <form class="d-flex flex-column gap-1" action="" method="get">
        <div class="d-flex flex-column gap-2" style="width: 16rem;">
            <input class="p-2 text-white bg-dark border border-danger" type="email" id="email" placeholder="Usuário"/>
            <input class="p-2 text-white bg-dark border border-danger" type="password" id="password" placeholder="Senha"/>
        </div>
